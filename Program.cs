...
{
    public static StackArray? stack;
    ...
    private static void Main(string[] args)
    {
        ...
        {
            Console.Clear();
            Console.WriteLine("This is Pure Array Based Stack Implementation\n");
            Console.Write("Please input the size of stack you want : ");
            int.TryParse(Console.ReadLine(), out size);

            if (size <= 0)
            {
                Console.Clear();
                Console.Write("Please Input The Size Of Stack Greater Than 0 (>0)");
                Console.Clear();
            }
            else
            {
        ...
        Console.Clear();
        int choice;
        string[] MenuItems = { "Push", "Pop", "Top", "Print Stack", "Is Empty", "Is Full", "Stack Size", "Exit" };
        int data;
